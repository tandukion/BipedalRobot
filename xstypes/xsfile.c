...
*/
XsResultValue XsFile_truncate(struct XsFile *thisPtr, XsSize fileSize)
{
...
*/
XsResultValue XsFile_resize(struct XsFile *thisPtr, XsSize fileSize)
{
#ifdef _WIN32
	int32_t rv = _chsize_s(_fileno(thisPtr->m_handle), fileSize);
#else	
