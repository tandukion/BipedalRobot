...
*/
template <>
inline void XsMessage::getData<XsReal>(XsReal* data, XsDataIdentifier id, XsSize offset, int numValues) const
{
...
*/
template <>
inline void XsMessage::setData<XsReal>(XsReal const* data, XsDataIdentifier id, XsSize offset, int numValues)
{
