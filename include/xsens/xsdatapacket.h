...
struct XsDataPacket {
	...
	*/
	...
	/*! \brief \copybrief XsDataPacket_gpsPvtData(const XsDataPacket*, XsGpsPvtData*) */
	...
	/*! \copydoc XsDataPacket_containsGpsPvtData(const XsDataPacket*) */
	inline bool containsGpsPvtData(void) const
	{
		return 0 != XsDataPacket_containsGpsPvtData(this);
	}

	/*! \copydoc XsDataPacket_setGpsPvtData(XsDataPacket*, const XsGpsPvtData*) */
	...
	*/
	...
	/*! \brief \copybrief XsDataPacket_utcTime(const XsDataPacket*, XsUtcTime*)
	...
	*/
	...
	/*! \copydoc XsDataPacket_setUtcTime(XsDataPacket*, const XsUtcTime*) */
	...
	/*! \brief \copybrief XsDataPacket_rawGpsDop(const XsDataPacket*, XsRawGpsDop*) */
	...
	/*! \brief \copybrief XsDataPacket_containsRawGpsDop(const XsDataPacket*) */
	inline bool containsRawGpsDop(void) const
	{
		return 0 != XsDataPacket_containsRawGpsDop(this);
	}

	/*! \copydoc XsDataPacket_setRawGpsDop(XsDataPacket*, const XsRawGpsDop*) */
	XSNOEXPORT inline void setRawGpsDop(XsRawGpsDop const& data)
	{
		XsDataPacket_setRawGpsDop(this, &data);
	}

	/*! \brief \copybrief XsDataPacket_rawGpsSol(const XsDataPacket*, XsRawGpsSol*) */
	...
	/*! \brief \copybrief XsDataPacket_containsRawGpsSol(const XsDataPacket*) */
	inline bool containsRawGpsSol(void) const
	{
		return 0 != XsDataPacket_containsRawGpsSol(this);
	}

	/*! \copydoc XsDataPacket_setRawGpsSol(XsDataPacket*, const XsRawGpsSol*) */
	XSNOEXPORT inline void setRawGpsSol(XsRawGpsSol const& data)
	{
		XsDataPacket_setRawGpsSol(this, &data);
	}

	/*! \brief \copybrief XsDataPacket_rawGpsTimeUtc(const XsDataPacket*, XsRawGpsTimeUtc*) */
	...
	/*! \brief \copybrief XsDataPacket_containsRawGpsTimeUtc(const XsDataPacket*) */
	inline bool containsRawGpsTimeUtc(void) const
	{
		return 0 != XsDataPacket_containsRawGpsTimeUtc(this);
	}

	/*! \copydoc XsDataPacket_setRawGpsTimeUtc(XsDataPacket*, const XsRawGpsTimeUtc*) */
	XSNOEXPORT inline void setRawGpsTimeUtc(XsRawGpsTimeUtc const& data)
	{
		XsDataPacket_setRawGpsTimeUtc(this, &data);
	}

	/*! \brief \copybrief XsDataPacket_rawGpsSvInfo(const XsDataPacket*, XsRawGpsSvInfo*) */
	...
	/*! \brief \copybrief XsDataPacket_containsRawGpsSvInfo(const XsDataPacket*) */
